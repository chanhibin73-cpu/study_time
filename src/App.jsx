...
export default function App() {
  ...
  // キーを変更し、以前のダミーデータをリセットして完全に新規状態にする
  const STORAGE_KEY = 'fit_and_study_records_v3';
      ...
      <main className="flex-1 max-w-md w-full mx-auto px-4 py-6">
        ...
        {activeTab === 'history' && (
          <div className={`${pageTransitionClass} pb-6`}>
            ...
            <div key={selectedDateStr} className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 animate-in slide-in-from-top-4 fade-in duration-300 mt-4">
